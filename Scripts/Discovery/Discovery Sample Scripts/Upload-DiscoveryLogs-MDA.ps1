<################################################################################################################################################
   ...
   5. (lines 18-190 Replace <Folder> with the path to the "Discovery" folder
...
$sourceLogFolder = "<Folder>\Discovery\NewLogs" #This is the folder where you copy the firewall logs to
$destinationLogFolder = "<Folder>\Discovery\ArchivedLogs" #This is the folder where you want to move the processed logs to
